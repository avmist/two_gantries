...
// You may need to change FAN_PIN to 16 because Greenback isn't using fastio.h
...
#ifdef AT90USBxx_TEENSYPP_ASSIGNMENTS  // use Teensyduino Teensy++2.0 pin assignments instead of Greenback traditional.
#error These Teensylu/Printrboard assignments depend on traditional Greenback assignments, not AT90USBxx_TEENSYPP_ASSIGNMENTS in fastio.h
#endif
...
#if MB(BRAINWAVE)
#define KNOWN_BOARD 1
#define AT90USB 646  // Disable GreenbackSerial etc.
...
#ifndef AT90USBxx_TEENSYPP_ASSIGNMENTS  // use Teensyduino Teensy++2.0 pin assignments instead of Greenback alphabetical.
  #error  Uncomment #define AT90USBxx_TEENSYPP_ASSIGNMENTS in fastio.h for this config
  // or build from command line with:  DEFINES=AT90USBxx_TEENSYPP_ASSIGNMENTS HARDWARE_MOTHERBOARD=84  make
#endif

#define X_STEP_PIN         28 //  0 Greenback
#define X_DIR_PIN          29 //  1 Greenback
#define X_ENABLE_PIN       26 

#define Y_STEP_PIN         30 //  2 Greenback
