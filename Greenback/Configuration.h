...
#define EXTRUDERS 1
// This defines the number of bio extruders
#define BIOEXTRUDERS 1
...
// SL Note: bioprinter does not have bed or extruder 0 connected
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,1512,800}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {50.25,50.25,756.00,408.00}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {44.7,44.7,1512,800}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.0,100.0,1512,800}  // default steps per unit for Ultimaker
 ...
 * Bioprinter is currently an array of extruders in tandem with 
 * filament extruder. Filament extruder is position 0,0 for reference.
 * Motherboards
 * Bioprinter is controlled by an independent Arduino Uno in communication
 *  with the RAMPS1.4 board through SPI. 
 *
 * Note may require analog pins to be defined for different motherboards
 **********************************************************************/
// Uncomment below to enable
